...
<div class="card border-2 mt-2">
    <div class="card-header bg-white py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Lembur Disetujui</h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-hover align-middle mb-0" style="width:100%; border: 1px solid #dee2e6;">
                <thead class="table" style="background-color: #CEE5FF;">
                    <tr class="text-center">
                        ...
                        <th style="width: 9%">Tgl Lembur</th>
                        <th style="width: 20%">Keterangan</th>
                        <th style="width: 9%">Jam</th>
                        <th style="width: 10%">Jenis</th>
                        <th style="width: 8%">Total Jam</th>
                        <th style="width: 9%">Bayar / Deposit</th>
                        <th style="width: 9%">Permohonan</th>
