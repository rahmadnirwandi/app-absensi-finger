<form action="{{ url($action_form) }}" method="{{ !empty($method_form) ? $method_form : 'POST' }}">
    @csrf
    <?php 
        $kode=!empty($model->id_status_karyawan) ? $model->id_status_karyawan : '';
    ?>
    ...
    <div class="row justify-content-start align-items-end mb-3">
        <div class="col-lg-4">
            <div class='bagan_form'>
                <label for="nm_status_karyawan" class="form-label">Nama Status Karyawan</label>
                <input type="text" class="form-control" id="nm_status_karyawan" name='nm_status_karyawan' required
